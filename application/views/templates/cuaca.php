    ...
    <div class="row p-b-30 mt-3">
                    <div class="col-md-12">
                            <div class="heading text-center">
                                <h2>Prakiraan Cuaca Jawa Tengah Hari Ini</h2>
                            </div>
                    </div>
            </div>
            <div class="row mb-4 justify-content-center mx-auto">
                
                    <div class="col-md-12 col-sm-6 col-xs-12 mx-auto">
                ...
                <section>
                    <div class="container ">
                        <div class="row mb-5">
                            ...
                            <img src="<?= base_url();?>image/img_terkini/<?= $b['nm_file']; ?>"  height="100%" width="100%">
                                <?php endforeach;?>
                            <?php endif;?>
                        </div>
                    </div>
